...
$bossName = 'Greatwood'; // ← změň podle jména bosse
...
<main class="main-wrapper">
    ...
    <h2>Curse-Rotted Greatwood</h2>

    <h3>Lokace: Undead Settlement</h3>
    <div>
        <p>Greatwood býval posvátný strom, uctívaný obyvateli Undead Settlement jako prostředek, jak se zbavit kleteb. Lidé do něj pohřbívali prokleté předměty i mrtvoly – až se z něj stal shnilý a zmutovaný kolos, přetékající nemocí a temnotou. Je doslova přeplněn pozůstatky lidského zoufalství. Není zlý z podstaty, ale přetvořený šílenstvím těch, kteří se snažili zbavit svého utrpení.</p>
        <p>Fáze 1: Začíná jako standardní strom s obřími končetinami. Cílem není standardní poškození, ale rozbíjení bílých hnisavých útvarů.</p>
        <p>Fáze 2: Po propadu podlahy se z něj vynoří ruka a přebírá hlavní ofenzivu. Útočí dlouhými švihy, padajícími tělem, hází sebou a snaží se rozmáčknout hráče. Weakspoty jsou nově rozmístěny po těle.</p>
    </div>
