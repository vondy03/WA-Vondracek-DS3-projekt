...
$bossName = 'Pontiff'; // ← změň podle jména bosse
...
<main class="main-wrapper">
    ...
    <h2>Pontiff Sulyvahn</h2>

    <h3>Lokace: Irithyll of the Boreal Valley</h3>
    <div>
        <p>Pontiff Sulyvahn je jednou z nejtemnějších postav ve světě Dark Souls III. Byl původně učencem magie, ale místo světla a vědění se obrátil k temnotě. Objevil dva ohně – oheň temna a světla – a spojil je v jednu sílu. Stal se tyranem Irithyllu, vládcem fanatiků a tvůrcem Aldriche. Je ztělesněním zkažené církevní autority, která používá víru k ovládnutí mas.</p>
        <p>Fáze 1: Bojuje se dvěma meči – jeden temný a jeden ohnivý. Má dlouhé kombo útoky, skoky a švihy. Extrémně agresivní.</p>
        <p>Fáze 2: Vytvoří stínového dvojníka, který kopíruje jeho útoky s mírným zpožděním. Tím se bojiště mění na chaotické peklo. Hráč musí zvládnout časování a prostorový pohyb.</p>
    </div>
