...
$bossName = 'Sage'; // ← změň podle jména bosse
...
<main class="main-wrapper">
    ...
    <h3>Lokace: Road of Sacrifices</h3>
    <div>
        <p>Christopher Sage je jeden z posledních žijících adeptů Church of the Deep. V době před padnutím Anorithu se pokoušel prozkoumat tajemné krystaly v Blue Cathedral a ovládnout jejich energii. Avšak magické experimenty s krystaly způsobili, že se jeho podstata bytí se rozdělila. Původní „Crystal Sage“ zůstal uvězněn v prastaré magii, která vytvořila nekonečné klony a iluze, jež nyní střeží průchod údolím.</p>
        <p>Fáze 1: Crystal Sage bojuje za pomoci magie a používá teleportační útoky. Začne sesílat Soul Darts, Crystal Soul Spears a dokáže se rozdělit do dvou klonů. Každý klon opakuje podobné útoky, takže je třeba dobře sledovat, který z klonů je „pravý“.</p>
        <p>Fáze 2: Po ztrátě asi 50 % zdraví se Sage začíná teleportovat rychleji, sesílá častěji Hom­ing Soulmass a přidává Crystal Magic Shield, který na chvíli blokuje poškození. V této fázi musí hráč neustále sledovat Rift (portál), odkud se Sage objeví, a rychle zasáhnout, než dokáže seslat silné AoE kouzlo.
