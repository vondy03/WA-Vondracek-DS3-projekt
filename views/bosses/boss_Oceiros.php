...
$bossName = 'Oceiros'; // ← změň podle jména bosse
...
<main class="main-wrapper">
    ...
    <h2>Oceiros, the Consumed King</h2>

    <h3>Lokace: Consumed King’s Garden</h3>
    <div>
        <p>Oceiros je bývalým králem Lothricu a otcem prince Lothrica. Ve snaze najít osvícení a vědění propadl posedlosti týkající se draků. Pokusil se napodobit jejich nesmrtelnost, ale zaplatil šílenstvím. V boji mluví k neviditelnému dítěti jménem Ocelotte – což naznačuje, že jeho experimenty zasáhly i jeho rodinu. Jeho deformované tělo a plazivé pohyby jsou důsledkem jeho dračí transformace, která nebyla nikdy dokončena.</p>
        <p>Fáze 1: Pomalejší, ale nebezpečné útoky s dračí magií a švihy ocasem. Mluví na „Ocelotta“.</p>
        <p>Fáze 2: Ztrácí rozum, stává se agresivnějším. Bojuje divoce, častěji se plazí, má rychlejší útoky a zuřivost. Přidává výkřiky a AoE útoky.</p>
    </div>
