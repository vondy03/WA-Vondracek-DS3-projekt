...
$bossName = 'Watchers'; // ← změň podle jména bosse
...
<main class="main-wrapper">
    ...
    <h2>Abyss Watchers</h2>

    <h3>Lokace: Farron Keep</h3>
    <div>
        <p>Abyss Watchers jsou strážci, vyvolaní Ludlecem Gundyrem, aby zabránili šíření Abyssu. Když však jeden z nich podlehl Abyssu, řád padl a nyní je každý člen součástí nekonečného boje o zachání si alespoň malého kousku vlastní vůle.</p>
        <p>Fáze 1: Na bojiště vkročí více „Abyss Watchers“, ale opravdu aktivní je jen jeden. Aktivní rytíř používá vířivé seky mečem, rychlé soustředěné švihy a malou skupinu ohnivých výbuchů.</p>
        <p>Fáze 2: Po poražení prvního Watchera se jejich duše spojí do jednoho těla a nastává opravdový souboj. Abyss Watcger začne využívat ohnivou magii a pohltí jí i svůj meč, který začne dávat ohnivé poškození. Celkově se taky stane více agresivním s novými sekvencemi a širokými AOE útoky</p>
    </div>
