...
$bossName = 'Wolnir'; // ← změň podle jména bosse
...
<main class="main-wrapper">
    ...
    <h2>High Lord Wolnir</h2>

    <h3>Lokace: Catacombs of Carthus</h3>
    <div>
        <p>Wolnir kdysi sdílel moc s Pontiffem Sulyvahnem a patřil k váženým lordům. Avšak propadl posedlosti temnou magií, která se skrývala v temných katakombách Carthusu. Nechal povstat armádu nemrtvých, avšak ta se po nějakém čase obrátila proti němu a jeho moc slábla. Wolnir si tedy pro sebe vytvořil velké zlaté náramky, jež drží zbytky jeho mocné, ale ztrácející se síly</p>
        <p>Fáze 1: Sám High Lord (obří kostlivec) stojí na jednom místě. Nejbezpečnější strategií je zaměřit se na zničení zlatých náramků na jeho zápěstích — nejprve pravý, poté levý.</p>
        <p>Fáze 2: Jakmile jsou všechny náramky zničeny (obvykle jsou tři), Wolnir ztratí životaschopnost ochrany a jeho lebka začne být zranitelná. Jeho útoky zůstanou podobné, ale poškození se mírně zvýší, a k nim přidá výbuchy temnoty (Dark Breath AoE).</p>
    </div>
