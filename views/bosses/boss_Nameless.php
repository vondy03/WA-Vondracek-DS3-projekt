...
$bossName = 'Nameless'; // ← změň podle jména bosse
...
<main class="main-wrapper">
    ...
    <h3>Lokace: Archdragon Peak</h3>
    <div>
        <p>Nameless King je nejmocnější válečník v celém světě Dark Souls. Je to ztracený syn Gwynna, který se obrátil zády ke světlu a přidal se k drakům. Kvůli tomu byl vymazán z historie – jeho jméno bylo zapomenuto. Vládne obloze a je zosobněním hromu a bouře. Jako Král bouře přilétá na hřbetu draka, s blesky v rukou. Je to nejtěžší boss v celé hře a vyvrcholení celé cesty.</p>
        <p>Fáze 1: Nameless King nejprve přiletí na drakovi. Drak útočí ohněm a hlavou, Nameless ho podporuje blesky.</p>
        <p>Fáze 2: Po zabití draka z něj seskočí a začne sám bojovat. Má kopí nabité bleskem, rychlé a silné útoky, vířivé kombinace a AoE údery. Patří k bossům nejnáročněším na reflexy a rytmus.</p>
    </div>
