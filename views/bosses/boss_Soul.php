...
$bossName = 'Soul'; // ← změň podle jména bosse
...
<main class="main-wrapper">
    ...
    <h2>Soul of Cinder</h2>

    <h3>Lokace: Kiln of the First Flame</h3>
    <div>
        <p>Soul of Cinder je konečná manifestace všech předchozích Pánů ohně – Gwyn, Ludlece, Yhorm, Aldrich a další. Při vyhasnutí Plamene se jejich duše spojily v jednoho strážce, který bude věčně hlídat poslední plamen. Soul of Cinder představuje završení cyklu trvacího od počátku světa.</p>
        <p>Soul of Cinder využívá schpoností předchozích Pánů ohně a plynule mezi nimi v průběhu boje přechází. Mezi fáze patří meč a blesky, pyromancie, kopí a blesky a agresivní postoj s meči</p>
    </div>
