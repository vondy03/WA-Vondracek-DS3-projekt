...
?>
<head><title>Registrace</title></head>
...
<body>
    ...
    <div style="background-color: rgba(0, 0, 0, 0.7); padding: 2rem; border-radius: 10px; max-width: 1200px; text-align: center; box-shadow: 0 0 10px rgba(0, 0, 0, 0.8);">
        <h2 style="color: rgb(255, 94, 19); font-family: 'Cinzel', serif; font-size: 2.2rem; margin-bottom: 1rem;">Registrace</h2>
...
<input type="text" id="username" name="username" required style="width: 100%; padding: 0.7rem; font-size: 1rem; border: none; border-radius: 5px; margin-bottom: 1rem; background-color: #fdfdfd; color: #000;">
    <label for="email" style="display: block; text-align: left; margin: 1rem 0 0.3rem; font-family: 'IM Fell English', serif; font-size: 1.1rem;">Email (volitelné)</label>
            <input type="email" name="email" style="width: 100%; padding: 0.7rem; font-size: 1rem; border: none; border-radius: 5px; margin-bottom: 1rem; background-color: #fdfdfd; color: #000;">
    ...
    <button type="submit" style="width: 100%; padding: 0.8rem; background-color: rgb(255, 94, 19); border: none; border-radius: 5px; font-size: 1.2rem; font-family: 'Cinzel', serif; color: #fff; cursor: pointer; transition: background-color 0.3s ease;" >Registrovat se</button>
</form>
</div>
</main>
